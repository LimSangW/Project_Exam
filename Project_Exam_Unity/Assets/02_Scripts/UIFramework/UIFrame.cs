    ...
    public class UIFrame : MonoBehaviour
    {
        ...
        public virtual void Initialize()
        {
            if (panelLayer == null)
            {
                ...
                if (panelLayer == null)
                {
                    DebugEx.LogError("[UI Frame] UI Frame lacks Panel Layer!");
                }
                else
                {
            ...
            if (windowLayer == null)
            {
                ...
                if (panelLayer == null)
                {
                    DebugEx.LogError("[UI Frame] UI Frame lacks Window Layer!");
                }
                else
                {
        ...
        public void ShowScreen(string screenId)
        {
            ...
            {
                DebugEx.LogError(string.Format("Tried to open Screen id {0} but it's not registered as Window or Panel!",
                    screenId));
            }
        }
