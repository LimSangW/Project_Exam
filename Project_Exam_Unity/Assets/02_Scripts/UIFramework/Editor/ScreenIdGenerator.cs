...
namespace Project.UIFramework.Editor
{
    public class ScreenIdProcessor : AssetPostprocessor
    {
        ...
        [MenuItem("Assets/Create/UIFramework/Re-generate UI ScreenIds")]
        ...
        public static void RegenerateScreenIds(bool refreshAssetDatabase)
        {
            ...
            foreach (var asset in assets)
            {
                ...
                if (screenController != null)
                {
                    ...
                    {
                        paths.Add(name, path);
                        DebugEx.Log(string.Format("Registering {0} as {1}", path, name));
                    }
                }
            }
            ...
            {
                DebugEx.LogError("Could not find ScreenIds script file! Create the file and try again.");
            }
        }
