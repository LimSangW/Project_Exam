...
namespace Project.UIFramework
{
    ...
    public abstract class AUILayer<TScreen> : MonoBehaviour where TScreen : IUIScreenController
    {
        ...
        public void RegisterScreen(string screenId, TScreen controller)
        {
            ...
            {
                DebugEx.LogError("[AUILayerController] Screen controller already registered for id: " + screenId);
            }
        }
        ...
        public void UnregisterScreen(string screenId, TScreen controller)
        {
            ...
            {
                DebugEx.LogError("[AUILayerController] Screen controller not registered for id: " + screenId);
            }
        }
        ...
        public void ShowScreenById(string screenId)
        {
            ...
            {
                DebugEx.LogError("[AUILayerController] Screen ID " + screenId + " not registered to this layer!");
            }
        }
        ...
        public void ShowScreenById<TProps>(string screenId, TProps properties) where TProps : IScreenProperties
        {
            ...
            {
                DebugEx.LogError("[AUILayerController] Screen ID " + screenId + " not registered!");
            }
        }
        ...
        public void HideScreenById(string screenId)
        {
            ...
            {
                DebugEx.LogError("[AUILayerController] Could not hide Screen ID " + screenId + " as it is not registered to this layer!");
            }
        }
